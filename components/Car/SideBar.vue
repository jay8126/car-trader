...
const onChangePrice = () => {
	...
	// navigateTo(
	// 	`/city/${route.params.city}/car/${route.params.make}?minPrice=${priceRange.min}&maxPrice=${priceRange.max}`,
	// );
};
</script>
...
<template>
	<div class="shadow border w-64 mr-10 z-30 h-[190px]">
		...
		<div class="p-5 flex justify-between relative cursor-pointer border-b">
			...
			<div
				class="absolute border shadow left-56 p-5 top-1 -m-1 w-[600px] flex justify-between flex-wrap bg-white text-black"
				v-if="modal.make"
			>
				<h4
					v-for="make in makes"
